         ...
         <div class="header_to d_none">
            <div class="container">
               <div class="row">
                  ...
                  <div style="margin-left: 750px; color: white;">
                  		...
                  		Welcome 
                  		<br>
                  		Your Email : <%= session.getAttribute("myemail") %>
                  		<br>
                  		Your Name : <%= session.getAttribute("myname") %>
                  		<br>
                  		Your Phone : <%= session.getAttribute("myphone") %>
            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Call Us : +09999999999</a> </li>
                     </ul>
                  </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="team.jsp">Wishlist </a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="client.jsp">Cart</a>
                              </li>
